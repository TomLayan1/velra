      ...
      <div className='container mx-auto'>
        <div className='w-[90%] mx-auto flex justify-evenly items-center gap-6'>
          <div className='md:w-[50%] lg:w-[40%]'>
            <h1 className='text-5xl font-bold font-[Crimson] mb-8 leading-16'>Our Process <br /><span className='lg:ml-36'>Your Comfort</span></h1>
            ...
            <button className='bg-black text-white text-[14px] font-medium font-[Crimson] px-5 py-3 rounded-full cursor-pointer'>Learn More</button>
          </div>
